...
// TODO: COMMON ENTITY ACTIONS RENAME
export const CommonDataActions = ({
  ...
  // TODO: bad code refactor the whole management of the modals
  ...
  return (
    <>
      <button
        onClick={() => openTagsModal(ADD_TAGS_MODE)}
        className="btn-md btn-neutral"
      >
        Add Tags{' '}
      </button>
      <button
        onClick={() => openTagsModal(REMOVE_TAGS_MODE)}
        className="btn-md btn-neutral"
      >
        Remove Tags{' '}
      </button>
      <button onClick={remove} className="btn-md btn-neutral">
        Delete
      </button>
    </>
  );
